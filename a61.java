// SQUARE, SQUAREROOT, FACTORIAL, CUBE
import javax.swing.*;
import java.awt.*;
...
class c1 extends JFrame{
        ...
        l1.setBounds(400,300,300,45);
        l1.setFont(new Font("ALGERIAN",Font.BOLD,40));
        l1.setForeground(Color.RED);

        l2=new JLabel(" RESULT: ");
        l2.setBounds(400,400,300,45);
